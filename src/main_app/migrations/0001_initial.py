            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="bcc", to="main_app.EmailAddress"
                    ),
                ),
                (
                    "cc",
                    models.ManyToManyField(
                        blank=True, related_name="cc", to="main_app.EmailAddress"
                    ),
                ),
                (
                    "domain",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="from_field",
                        to="main_app.emailaddress",
                    ),
                ),
                (
                    "template",
                ...
                (
                    "to",
                    models.ManyToManyField(
                        related_name="to", to="main_app.EmailAddress"
                    ),
                ),
            ],
        ),
